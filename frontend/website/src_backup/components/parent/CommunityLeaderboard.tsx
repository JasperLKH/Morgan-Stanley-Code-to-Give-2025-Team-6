...
export function CommunityLeaderboard({ kindergartenId }: LeaderboardProps) {
  ...
  const ParentLeaderboardCard = ({ parent, isCurrentUser = false }: { parent: LeaderboardEntry; isCurrentUser?: boolean } & React.ComponentProps<'div'>) => (
  ...
  const KindergartenLeaderboardCard = ({ kindergarten, isCurrentUserKindergarten = false }: { kindergarten: KindergartenRanking; isCurrentUserKindergarten?: boolean } & React.ComponentProps<'div'>) => (
    <Card className={`transition-all duration-200 ${
