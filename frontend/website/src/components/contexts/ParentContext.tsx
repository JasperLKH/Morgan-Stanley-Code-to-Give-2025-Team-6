...
const translations = {
  en: {
    ...
    'community.filterCategories': 'Filter Categories',
    'community.allCategories': 'All Categories',
    'community.generalDiscussion': 'General Discussion',
    'community.learningTips': 'Learning Tips',
    'community.parentSupport': 'Parent Support',
    'community.celebrations': 'Celebrations',
    ...
    'community.errorLoading': 'Error loading posts',
    ...
    'rewards.subtitle': 'Redeem your points for amazing rewards and vouchers',
    'rewards.yourPoints': 'Your Points',
    'rewards.totalPoints': 'Total Points',
    'rewards.thisWeek': 'This Week',
    'rewards.progressToNext': 'Progress to next reward',
    'rewards.points': 'points',
    'rewards.voucher': 'voucher',
    'rewards.coupon': 'coupon',
    'rewards.activity': 'activity',
    'rewards.unavailable': 'Unavailable',
    'rewards.needMore': 'Need',
    'rewards.morePoints': 'more points',
    'rewards.redeemNow': 'Redeem Now',
    'rewards.redeemReward': 'Redeem Reward',
    'rewards.confirmRedeem': 'Are you sure you want to redeem this reward?',
    'rewards.cost': 'Cost',
    'rewards.currentPoints': 'Current points',
    'rewards.afterRedemption': 'After redemption',
    'rewards.cancel': 'Cancel',
    'rewards.confirm': 'Confirm',
    'rewards.redeeming': 'Redeeming...',
    'rewards.howToEarn': 'How to Earn Points',
    'rewards.completeAssignments': 'Complete Assignments',
    'rewards.completeAssignmentsDesc': 'Earn 5-15 points per assignment',
    'rewards.dailyStreak': 'Daily Streak',
    'rewards.dailyStreakDesc': 'Bonus points for consecutive days',
    'rewards.communityParticipation': 'Community Participation',
    'rewards.communityParticipationDesc': 'Engage in forum discussions',
    'rewards.loadingRewards': 'Loading rewards...',
  },
  zh: {
    // Dashboard
    ...
    'community.searchPosts': '搜索貼文...',
    'community.filterCategories': '篩選類別',
    'community.allCategories': '所有類別',
    'community.generalDiscussion': '一般討論',
    'community.learningTips': '學習技巧',
    'community.parentSupport': '家長支援',
    'community.celebrations': '慶祝',
    'community.createPost': '建立新貼文',
    'community.postTitle': '貼文標題',
    'community.postContent': '您想要分享什麼？',
    'community.selectCategory': '選擇類別',
    'community.cancel': '取消',
    'community.creating': '建立中...',
    'community.newPost': '新貼文',
    'community.ago': '前',
    'community.likes': '個讚',
    'community.comments': '則留言',
    'community.viewComments': '查看留言',
    'community.hideComments': '隱藏留言',
    'community.addComment': '新增留言...',
    'community.loadingPosts': '載入貼文中...',
    'community.noPosts': '尚無貼文。成為第一個分享的人！',
    'community.errorLoading': '載入貼文時發生錯誤',
    ...
    // Rewards
    'rewards.title': '獎勵商店',
    'rewards.subtitle': '用您的積分兌換精彩的獎勵和優惠券',
    'rewards.yourPoints': '您的積分',
    'rewards.totalPoints': '總積分',
    'rewards.thisWeek': '本週',
    'rewards.progressToNext': '距離下一個獎勵的進度',
    'rewards.points': '積分',
    'rewards.voucher': '優惠券',
    'rewards.coupon': '折扣券',
    'rewards.activity': '活動',
    'rewards.unavailable': '不可用',
    'rewards.needMore': '還需要',
    'rewards.morePoints': '更多積分',
    'rewards.redeemNow': '立即兌換',
    'rewards.redeemReward': '兌換獎勵',
    'rewards.confirmRedeem': '您確定要兌換此獎勵嗎？',
    'rewards.cost': '費用',
    'rewards.currentPoints': '當前積分',
    'rewards.afterRedemption': '兌換後',
    'rewards.cancel': '取消',
    'rewards.confirm': '確認',
    'rewards.redeeming': '兌換中...',
    'rewards.howToEarn': '如何賺取積分',
    'rewards.completeAssignments': '完成作業',
    'rewards.completeAssignmentsDesc': '每份作業可獲得5-15積分',
    'rewards.dailyStreak': '每日連續',
    'rewards.dailyStreakDesc': '連續天數獲得獎勵積分',
    'rewards.communityParticipation': '社區參與',
    'rewards.communityParticipationDesc': '參與論壇討論',
    'rewards.loadingRewards': '載入獎勵中...',
  },
};
