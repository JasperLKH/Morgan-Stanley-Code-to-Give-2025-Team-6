...
export function SimplifiedAssignmentsPage() {
  ...
  const [assignments] = useState<Assignment[]>([
    ...
    {
      id: '3',
      title: 'English Color Recognition Activity',
      titleZh: '顏色識別活動',
      subject: 'English',
      subjectZh: '英文',
      dueDate: '2025-08-20',
    ...
    },
    {
      ...
      points: 3,
      grade: 'Good',
      feedback: 'Alphabet A-E are written well. Keep practicing alphabet F-L for better formation.',
      feedbackZh: '字母A-E寫得很好。繼續練習字母F-L以更好地形成。',
